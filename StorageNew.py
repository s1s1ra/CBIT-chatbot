...
class ChaituStore(StorageAdapter):
    """
    The ChaituStore allows ChatterBot to store conversation
    ...
    def get_statement_model(self):
        ...
        """
        from StatementC import Statement
        return Statement
    ...
    def get_tag_model(self):
        ...
        """
        from StatementC import Tag
        return Tag


    def model_to_object(self, statement):
        from StatementNew import Statement as StatementObject
    ...
    def filter(self, **kwargs):
        ...
        if search_text_contains:
            or_query = [
                Statement.search_in_response_to.contains(word) for word in search_text_contains.split(' ')
            ]
            statements = statements.filter(
                or_(*or_query)
            )
    ...
    def create(self, **kwargs):
        ...
        if 'search_in_response_to' not in kwargs:
            if kwargs.get('in_response_to'):
                kwargs['search_in_response_to'] = sw.remove(kwargs['in_response_to'])
    ...
    def create_many(self, statements):
        ...
        for statement in statements:
            ...
            if not statement.search_in_response_to and statement.in_response_to:
                statement_model_object.search_in_response_to = sw.remove(statement.in_response_to)
    ...
    def update(self, statement):
        ...
        if statement is not None:
            ...
            if statement.in_response_to:
                record.search_in_response_to = sw.remove(statement.in_response_to)
