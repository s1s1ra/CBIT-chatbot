...
class LevenshteinDistance(Comparator):
    ...
    def compare(self, statement, other_statement):
        ...
        if not statement.text or not other_statement.in_response_to:
            return 0

        # Get the lowercase version of both strings
        statement_text = str(statement.text.lower())
        other_statement_text = str(other_statement.in_response_to.lower())
...
class SynsetDistance(Comparator):
    ...
    def compare(self, statement, other_statement):
        ...
        tokens2 = word_tokenizer.tokenize(other_statement.in_response_to.lower())
...
class SentimentComparison(Comparator):
    ...
    def compare(self, statement, other_statement):
        ...
        statement2_polarity = sentiment_analyzer.polarity_scores(other_statement.in_response_to.lower())
...
class JaccardSimilarity(Comparator):
    ...
    def compare(self, statement, other_statement):
        ...
        b = other_statement.in_response_to.lower()
